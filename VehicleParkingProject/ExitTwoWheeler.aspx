<%@ Page Title="" Language="C#" MasterPageFile="~/twoWheelerMaster.Master" AutoEventWireup="true" CodeBehind="ExitTwoWheeler.aspx.cs" Inherits="VehicleParkingProject.ExitTwoWheeler" %>
    ...
    <script type="text/javascript">
        function CallCodeBehind() {
            ...
            if (window.confirm('Vehical Exitted')) {
                window.location.href = 'http://localhost:59459/ExitTwoWheeler.aspx';
            };
        } 
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style2">
        <tr>
            <td colspan="4">
                <asp:Button ID="Button1" runat="server" PostBackUrl="~/home.aspx" Text="Home" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ParkingProjectConnectionString %>" SelectCommand="SELECT [vid], [vname] FROM [vehicle_reg] WHERE (([slot] IS NOT NULL) AND ([type] = @type))">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="2-wheeler" Name="type" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="txtExitSlot" runat="server" Enabled="False" Width="175px"></asp:TextBox>
            </td>
        </tr>
